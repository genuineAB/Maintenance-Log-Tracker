  ...
  return (
    <div className="my-container">
      <div className="header">
        <h3>
          <i className="fa-solid fa-screwdriver-wrench"> Maintenance Logger</i>
        </h3>
        <p>
          Maintenance Logger helps you to effectively manage and track
          maintenance issues in your organization
        </p>
      </div>
      <div className="form-1">
        <form>
          ...
          <div>
            <button
              className="btn btn-1 waves-light"
              type="submit"
              name="action"
              onClick={onLogIn}
            >
        ...
        <div className="btn-items">
          <button
            className="waves-effect waves-light btn modal-trigger btn-2"
            href="#modal1"
          >
            Create New Account
          </button>
            ...
            <div className="row">
              <form className="col s12">
                ...
                <div className="modal-footer submit-btn">
                  <button
                    href="#!"
                    className="modal-close waves-effect btn-flat submit-1"
                    onClick={onSignUp}
                  >
                    Sign Up
                  </button>
                  <button
                    href="#!"
                    className="modal-close waves-effect btn-flat submit-2"
                  >
                    Close
                  </button>
                </div>
